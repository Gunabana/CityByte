...
from info.views import add_to_itinerary, remove_from_itinerary, itinerary_page, drop_pin, google_maps_api, map_view
...
urlpatterns = [
    ...
    path('google-maps-api', google_maps_api, name='google_maps_api'),
